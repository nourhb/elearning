@echo off
REM Simplified Production Build Script for Learning Management System (Windows)
REM This script prepares the application for deployment on Hostinger

echo 🚀 Starting Simplified Production Build Process...
...
REM Build the application (skip type checking)
...
if exist .env.production copy .env.production deployment\.env
