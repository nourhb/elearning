...
// import { seedDatabase } from '@/ai/flows/seed-database'; // Disabled for static export
import { z } from 'zod';
// import { revalidatePath } from 'next/cache'; // Disabled for static export
// import { deleteUser as deleteUserFlow } from '@/ai/flows/delete-user'; // Disabled for static export
...
// import { // Disabled for static export
//   notifyAdminsNewUser, 
...
export async function enrollInCourseAction(userId: string, courseId: string): Promise<{ success: boolean; message?: string }> {
    ...
    try {
        ...
        // const { createEnrollmentRequest } = await import('@/lib/services/enrollment-requests'); // Disabled for static export
        
        // await createEnrollmentRequest( // Disabled for static export
        //     db,
        //     userId,
        ...
        // revalidatePath('/courses'); // Disabled for static export
        // revalidatePath('/student/dashboard'); // Disabled for static export
